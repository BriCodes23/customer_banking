...
def main():
    ...
    interest_rate = float(input("Enter the interest rate for your savings account: "))
    ...
    # ADD YOUR CODE HERE
    print(updated_savings_balance, interest_earned *months )
    ...
    # ADD YOUR CODE HERE
    print(updated_cd_balance, interest_rate*months)
